...
welcomep.innerHTML = "welcome " + localStorage.getItem('ename') + " in all student publication report,"
...
// userRef.child("123Emp").once('value',function(snapshot){
...
userRef.once('value', function (snapshot) {
    ...
    snapshot.forEach(function (childSnapshot1) {
        ...
        facultyRef.child(childSnapshot1.key).child('student').once('value', function (snapshot1) {
            snapshot1.forEach(function (childSnapshot) {
                ...
                // userRef.child(childSnapshot1.key).once('value', function (snapshot2) {
                //     // document.getElementById("selected_name").remove().
                //     //   label.innerHTML = "name of employee: "+snapshot.val().name;
                //     //   document.getElementById("container").replaceChild(label,label);
                //     //console.log(""+snapshot.val().eid);
                //     localStorage.setItem('emloyeeId', snapshot2.val().eid);
                //     localStorage.setItem('employeeName', snapshot2.val().name);
                //     console.log("local eid is"+ localStorage.getItem('emloyeeId'));

                // });
                // emloyeeId = localStorage.getItem('emloyeeId');
                ...
                // localStorage.removeItem('emloyeeId');
