...
welcomep.innerHTML = "welcome " + localStorage.getItem('ename') + " select form name and eid ";
...
view.addEventListener('click', (e) => {
    ...
    // facultyRef.child(select.value).child('faculty').once('value', function (snapshot) {
    //     snapshot.forEach(function (childSnapshot) {
    //         var childKey = childSnapshot.key;
    //         var childData = childSnapshot.val();
    //         customers.push([
    ...
    console.log("form name is:"+localStorage.getItem('formName'));
    ...
    userRef.child(select.value).once('value', function (snapshot) {
        ...
        facultyRef.child(select.value).child(form_name).once('value',   function(snapshot) {
...
viewall.addEventListener('click', (e) => {
    e.preventDefault();
    //window.localStorage.setItem("formName",select2.value);
    window.location.href = "/newStart/admindynamicviewall.html";
});