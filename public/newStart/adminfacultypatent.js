...
welcomep.innerHTML = "welcome " + localStorage.getItem('ename') + " in faculty publication report, please select the eid to view respective employee publication";
...
viewall.addEventListener('click', (e) => {
    ...
    window.location.href = "/newStart/adminviewallfacultypublication.html";
});